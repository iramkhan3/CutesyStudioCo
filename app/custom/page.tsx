...
export const metadata: Metadata = {
  title: "Custom Decoden Phone Case, Hairbrush, Mirror & Keychain — Build Your Own",
  description:
    "Design your own custom decoden piece in India — phone case, hairbrush, hand mirror, table mirror, or keychain. Pick your theme, style, weight, and colours — or let us surprise you with a one-of-a-kind dream piece.",
  keywords: [
