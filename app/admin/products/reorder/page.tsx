  ...
  return (
    <div>
      ...
      <div className="mt-3 flex flex-wrap items-center justify-between gap-3">
        <div>
          <h1 className="font-heading text-3xl font-bold text-ink">Reorder products</h1>
          <p className="mt-1 text-ink-light">
            Drag to reorder — this controls the order on the Shop page and which products appear first in the
            homepage highlight (the top 9).
          </p>
        </div>
        <button
          onClick={handleSave}
      ...
      {!loading && products.length === 0 && !error && (
        <p className="mt-6 text-ink-light">No active products to reorder.</p>
      )}
          ...
          {products.map((p, i) => {
            ...
            return (
              ...
              >
                ...
                <span className="ml-auto text-xs text-ink-light">{p.category}</span>
              </li>
            );
          })}
        </ol>
