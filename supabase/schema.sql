...
values
  ...
  ('10000000-0000-0000-0000-000000000005', 'charm-garden-jewelry-box', 'Charm Garden Jewelry Box', 'jewelry-boxes', 'A mirrored jewelry box with a soft velvet interior and a lid piled high with bows and tiny charm blooms. The kind of thing that makes getting ready feel special.', 4799, '{/products/jewelry-boxes.svg}', 6, true),
  ...
  ('10000000-0000-0000-0000-000000000007', 'sugar-bow-comb', 'Sugar Bow Comb', 'combs', 'A gentle, wide-tooth comb with a handle transformed into a tiny charm garden — a bow, a swirl of cream, and a sprinkle of sparkle. Smooth on hair, soft on the eyes.', 1499, '{/products/combs.svg}', 15, true),
  ('10000000-0000-0000-0000-000000000008', 'bubblegum-bow-mirror', 'Bubblegum Bow Mirror', 'mirrors', 'A compact double-sided mirror dressed in bubblegum-pink cream swirls and a statement bow. Pops open for a touch-up, looks adorable left out on a desk.', 2399, '{/products/mirrors.svg}', 11, true),
  ('10000000-0000-0000-0000-000000000009', 'sweetheart-keychain-duo', 'Sweetheart Keychain Duo', 'keychains', 'A matching pair of heart-shaped charm clusters on a sturdy clasp — one for your keys, one for a friend. Cream swirls, a sprinkle of sparkle, and a tiny bow finish each one.', 1349, '{/products/keychains.svg}', 20, true),
  ('10000000-0000-0000-0000-000000000010', 'milky-star-keychain', 'Milky Star Keychain', 'keychains', 'A star-shaped charm swirled with pastel milk-white cream tones and topped with a tiny pearl accent. Small, sturdy, and impossible to leave off your bag.', 1249, '{/products/keychains.svg}', 18, true),
  ...
  ('10000000-0000-0000-0000-000000000012', 'lavender-dream-tablet-case', 'Lavender Dream Tablet Case', 'tablet-cases', 'A lilac padded case dusted in cream swirls with a trail of tiny charms along the spine. Protective corners, pillowy-soft feel, and full decoden charm coverage.', 3699, '{/products/tablet-cases.svg}', 5, true),
  ...
  ('10000000-0000-0000-0000-000000000014', 'ready-to-ship-cookies-cream-case', 'Ready-to-Ship Cookies & Cream Case', 'ready-to-ship', 'A warm caramel-toned case piled with cookie, biscuit, and pastry charms and a "SWEET" charm tucked in. One-of-one, ships in 1-2 days.', 1000, '{/products/real/cookies-cream-case.jpg}', 1, true),
  ...
  ('10000000-0000-0000-0000-000000000019', 'ready-to-ship-cinnamoroll-sky-case', 'Ready-to-Ship Cinnamoroll Sky Case', 'ready-to-ship', 'Baby-blue and white cream waves dotted with Cinnamoroll charms, bows, and butterflies, finished with a tiny "cute" charm. One-of-one, ships in 1-2 days.', 1000, '{/products/real/cinnamoroll-sky-case.jpg}', 1, true),
  ...
  ('10000000-0000-0000-0000-000000000025', 'ready-to-ship-bow-heart-mirror', 'Ready-to-Ship Bow & Heart Mirror', 'mirrors', 'A rectangular vanity mirror framed in lilac and pink cream, dotted with hearts, bows, and butterflies. One-of-one, ships in 1-2 days.', 1000, '{/products/real/bow-heart-mirror.jpg}', 1, true),
  ('10000000-0000-0000-0000-000000000026', 'ready-to-ship-hello-kitty-bag-charm', 'Ready-to-Ship Hello Kitty Bag Charm', 'keychains', 'A Hello Kitty bag charm dressed in pink cream swirls, bows, and a little "LOVE" charm — the easiest way to decoden-ify your bag or keys. One-of-one, ships in 1-2 days.', 1000, '{/products/real/hello-kitty-bag-charm.jpg}', 1, true)
